    ...
    return (
        <div id="itinerary-content" className="max-w-5xl mx-auto px-4 py-8 relative">
            <div ref={headerRef} className="bg-white rounded-3xl shadow-xl overflow-hidden animate-in fade-in slide-in-from-bottom-4">
                ...
                <div className="relative text-white overflow-hidden min-h-[300px] flex items-end">
                    {/* Background Image with Overlay */}
                    <div className="absolute inset-0 z-0">
                        <UnsplashImage
                            query={preferences?.destination || itinerary.tripName}
                            alt={itinerary.tripName}
                                    ...
                                    <div className="flex p-2 bg-gray-50 gap-2 overflow-x-auto">
                                        {[
                                            ...
                                            <button
                                                ...
                                                className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl border transition-all whitespace-nowrap ${paymentMethod === method.id
                                                    ...
                                                    <div className="flex gap-4 mb-6 border-b border-gray-200">
                                                        {[
                                                            ...
                                                            <button
                                                                ...
                                                                className={`pb-2 px-1 text-sm font-medium transition-all ${subPaymentMethod === sub.id
                                                                    ? 'border-b-2'
