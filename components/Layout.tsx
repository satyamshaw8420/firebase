...
import { Plane, Map, LayoutGrid, Users, Menu, X, UserCircle, Globe, Phone } from 'lucide-react';
...
const Navbar: React.FC = () => {
  ...
  const handleSignOut = async () => {
    try {
      await signOutUser();
      // logout(); // AuthContext listener will handle state update
      navigate('/');
          ...
          <div className="hidden xl:flex items-center gap-2">
            {currentUser ? (
              <button 
                ...
                className="flex items-center gap-1.5 bg-emerald-500 hover:bg-emerald-600 text-white px-3 py-2 rounded-full text-sm font-medium transition-all shadow-md shadow-emerald-200"
              >
                <UserCircle size={18} />
                <span>Sign Out</span>
              </button>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            {currentUser ? (
              <button
                ...
                className="flex items-center gap-3 px-3 py-2 rounded-md text-base font-medium text-emerald-600 bg-emerald-50"
              >
                <UserCircle size={18} />
                Sign Out
              </button>
    ...
    return (
        <footer className="bg-gray-900 text-white py-12 mt-auto">
            ...
            <div>
                ...
                <img src="/travelease logo.png" alt="TravelEase Logo" className="h-20 w-auto object-contain bg-black/10 rounded-lg p-1 hover:scale-105 transition-transform duration-200" />
