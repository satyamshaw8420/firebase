                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`flex flex-col items-center justify-center p-6 rounded-2xl border-2 transition-all duration-300 ${prefs.travelerType === item.type
                                    ...
                                    <div className="flex p-1 bg-gray-100 rounded-xl">
                                        {Object.values(BudgetType).map((type) => (
                                            <button
                                                ...
                                                className={`flex-1 py-3 px-2 rounded-lg text-sm font-bold transition-all ${prefs.budgetType === type
                                ...
                                <div className="flex flex-wrap gap-3">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`flex items-center gap-2 px-5 py-3 rounded-xl border transition-all ${prefs.transportModes.includes(item.mode)
                                ...
                                <div className="flex flex-wrap gap-3">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`flex items-center gap-2 px-4 py-2 rounded-full border transition-all text-sm font-medium ${prefs.interests.includes(item.name)
