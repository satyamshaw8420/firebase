...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative py-20 bg-gradient-to-br from-emerald-50 via-teal-50 to-sky-50 overflow-hidden">
        <div className="absolute -top-16 -left-16 w-72 h-72 bg-emerald-200/40 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-20 -right-20 w-96 h-96 bg-teal-200/40 rounded-full blur-3xl"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            initial="hidden"
            whileInView="visible"
            ...
            className="text-center mb-16"
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Community & Trip — Step by Step</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">From creating a community to joining trips and splitting expenses, follow these simple steps.</p>
          </motion.div>
          ...
          <motion.div 
            ...
            className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"
          >
            <motion.div variants={fadeInUp} className="p-6 rounded-2xl bg-gradient-to-br from-white to-emerald-50 border border-emerald-100 hover:shadow-xl transition-shadow duration-300">
              <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center mb-4 text-emerald-600">1</div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Create a Community</h3>
              <p className="text-gray-600 text-sm">Go to Community and create a new group with a name and description.</p>
            </motion.div>
            <motion.div variants={fadeInUp} className="p-6 rounded-2xl bg-gradient-to-br from-white to-emerald-50 border border-emerald-100 hover:shadow-xl transition-shadow duration-300">
              <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center mb-4 text-emerald-600">2</div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Add/Invite Members</h3>
              <p className="text-gray-600 text-sm">Share the invite code or add people directly. Members appear in the list.</p>
            </motion.div>
            <motion.div variants={fadeInUp} className="p-6 rounded-2xl bg-gradient-to-br from-white to-emerald-50 border border-emerald-100 hover:shadow-xl transition-shadow duration-300">
              <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center mb-4 text-emerald-600">3</div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Members Join</h3>
              <p className="text-gray-600 text-sm">Members accept invites and become part of the community.</p>
            </motion.div>
            <motion.div variants={fadeInUp} className="p-6 rounded-2xl bg-gradient-to-br from-white to-emerald-50 border border-emerald-100 hover:shadow-xl transition-shadow duration-300">
              <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center mb-4 text-emerald-600">4</div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Create a Trip</h3>
              <p className="text-gray-600 text-sm">Open Create Trip, set preferences, and generate your AI itinerary. Save it.</p>
            </motion.div>
            <motion.div variants={fadeInUp} className="p-6 rounded-2xl bg-gradient-to-br from-white to-emerald-50 border border-emerald-100 hover:shadow-xl transition-shadow duration-300">
              <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center mb-4 text-emerald-600">5</div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Invite & Join the Trip</h3>
              <p className="text-gray-600 text-sm">From the trip page, invite community members. They join and collaborate.</p>
            </motion.div>
            <motion.div variants={fadeInUp} className="p-6 rounded-2xl bg-gradient-to-br from-white to-emerald-50 border border-emerald-100 hover:shadow-xl transition-shadow duration-300">
              <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center mb-4 text-emerald-600">6</div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Add Expenses</h3>
              <p className="text-gray-600 text-sm">In Trip Collaboration, add expense, choose who paid, and select members to split.</p>
            </motion.div>
            <motion.div variants={fadeInUp} className="p-6 rounded-2xl bg-gradient-to-br from-white to-emerald-50 border border-emerald-100 hover:shadow-xl transition-shadow duration-300">
              <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center mb-4 text-emerald-600">7</div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">See Who Pays Whom</h3>
              <p className="text-gray-600 text-sm">Red means you pay, Green means you get. Arrows show direction: → Pay to, ← Get from.</p>
            </motion.div>
            <motion.div variants={fadeInUp} className="p-6 rounded-2xl bg-gradient-to-br from-white to-emerald-50 border border-emerald-100 hover:shadow-xl transition-shadow duration-300">
              <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center mb-4 text-emerald-600">8</div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Compare Trips</h3>
              <p className="text-gray-600 text-sm">Use Compare to analyze duration, daily costs, and activity distribution.</p>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/community"
                className="bg-emerald-500 hover:bg-emerald-600 text-white px-8 py-4 rounded-full text-lg font-semibold transition-all transform hover:scale-105"
              >
                Start in Community
              </Link>
              <Link 
                to="/my-trips"
                className="bg-white text-emerald-600 border border-emerald-300 px-8 py-4 rounded-full text-lg font-semibold transition-all hover:bg-emerald-50"
              >
                Open My Trips
              </Link>
            </div>
