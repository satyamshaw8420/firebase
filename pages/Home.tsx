        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Find Travel Buddies <ArrowRight className="w-5 h-5" />
              </Link>
            </motion.div>
            ...
            >
              ...
              <motion.div 
                ...
                className="absolute -bottom-6 -left-6 bg-white text-gray-900 p-4 rounded-xl shadow-xl max-w-xs hidden md:block"
              >
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-sm font-semibold text-emerald-600">+4 others joined</span>
                </div>
                <p className="text-xs text-gray-600">"Bali Trip 2024" group is active!</p>
              </motion.div>
            </motion.div>
          </div>
        </div>
